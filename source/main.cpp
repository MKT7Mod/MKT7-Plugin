...
exit:
    ...
    const std::string about =
        "Mario Kart Tour 7 - " STRING_VERSION "\n\n"
        "Currently purposed for OnionFS\n\n"
        "Credits: PabloMK7, Nanquitas, Midou360, NGT,\n"
        "CyberYoshi64, MKWmods";

    int     main(void)
    {
        PluginMenu *menu = new PluginMenu("MKT7", MAJOR_VERSION, MINOR_VERSION, REVISION_VERSION, about);
